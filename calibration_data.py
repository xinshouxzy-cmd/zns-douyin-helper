...
CALIBRATION_STEPS = [
    {"id": "1_通知图标", "label": "通知铃铛图标", "desc": "在浏览器中点击页面右上角的通知铃铛图标🔔", "tip": "通常在页面右上角，头像左侧"},
    {"id": "2_全部消息", "label": "「全部消息」按钮", "desc": "在弹出面板中点击「全部消息」标签页", "tip": "弹出通知面板后，找到「全部消息」标签页并点击"},
    {"id": "3_评论筛选", "label": "「评论」筛选标签", "desc": "在消息页面左侧点击「评论」筛选标签", "tip": "在消息页面左侧导航栏中，点击「评论」筛选标签"},
]
